class AppStrings {
  static const Map<String, Map<String, String>> translations = {
    'ar': {
      ...
      // ── Financial ──
      'receivables': 'الذمم',
      'accounts': 'حسابات المرضى',
      'invoices': 'الفواتير',
      'accounts_hint': 'فوترة مجمّعة من سجل كل مريض',
      'invoices_hint': 'فواتير مستقلة تُضاف هنا',
      'no_billing_accounts': 'لا توجد فوترة للمرضى بعد',
      'search_accounts': 'ابحث عن مريض',
      'charge': 'المبلغ',
      'charge_payment_hint': 'اتركه 0 لتسجيل دفعة فقط',
      'billing_needs_amount': 'أدخل مبلغًا أو دفعة أو كليهما',
      ...
      'add': 'إضافة',
      'failed_to_load_data': 'تعذّر تحميل البيانات',
      'select_patient_treatment': 'يرجى اختيار مريض ونوع علاج',
      'patient_schedule': 'المريض والموعد',
      'date_time': 'التاريخ والوقت',
      'treatment': 'العلاج',
      'treatment_type': 'نوع العلاج',
      'no_treatments_available': 'لا توجد علاجات متاحة',
      'select_treatment': 'اختر علاجًا',
    ...
    'en': {
      ...
      'accounts': 'Accounts',
      'invoices': 'Invoices',
      'accounts_hint': "Billing rolled up from each patient's sheet",
      'invoices_hint': 'Standalone invoices you add here',
      'no_billing_accounts': 'No patient billing yet',
      'search_accounts': 'Search patients',
      'charge': 'Charge',
      'charge_payment_hint': 'Leave 0 for a payment only',
      'billing_needs_amount': 'Enter a charge, a payment, or both',
      ...
      'select_patient_treatment': 'Please select a patient and treatment',
